...
import ProviderChat from '@/components/dashboard/providerChat';
import GalleryUploader from '@/components/dashboard/Gallery';
...
const Dashboard = () => {
 ...
 const menuItems = [
    ...
    { id: 'add-service', label: 'Add-Services', icon: Plus },
    { id: 'MyServices', label: 'My Services', icon: BarChart3 },
    { id: 'Chat', label: 'Messages', icon: MessageCircle },
    { id: 'gallery', label: 'Gallery', icon: Files },
